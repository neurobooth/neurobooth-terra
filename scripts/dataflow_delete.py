...
if dry_run:
    ...
    threshold = 0.85
    record_older_than_days = 35 # days (divide by num_secs_in_a_day to convert days to seconds for testing)
    copied_older_than_days = 30 # days (divide by num_secs_in_a_day to convert days to seconds for testing)
    # time elapsed is needed in seconds for sql query
    record_older_than = record_older_than_days * num_secs_in_a_day # seconds
    copied_older_than = copied_older_than_days * num_secs_in_a_day # seconds
